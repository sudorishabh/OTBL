...
const calculateExpirationDate = (expiresIn = "15m") => {
    ...
    switch (unit) {
        case "m": // minutes
            return (0, date_fns_1.add)(expirationDate, { minutes: parseInt(value || "0") });
        case "h": // hours
            return (0, date_fns_1.add)(expirationDate, { hours: parseInt(value || "0") });
        case "d": // days
            return (0, date_fns_1.add)(expirationDate, { days: parseInt(value || "0") });
        default:
