...
const WorkOrderStatCard = ({
  ...
  return (
    <div
      className='rounded-xl border p-4 bg-linear-to-br from-white to-gray-50 shadow-sm hover:shadow-md transition-shadow group hover:border-emerald-400 cursor-pointer'
