...
const WorkOrderStatCard = ({ Icon, stat, title }: Props) => {
  return (
    <div className='rounded-xl border p-4 bg-linear-to-br from-white to-gray-50 shadow-sm hover:shadow-md transition-shadow hover:border-emerald-400'>
